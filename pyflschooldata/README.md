...
Python wrapper for Florida school enrollment data.

This is a thin rpy2 wrapper around the [flschooldata](https://github.com/almartin82/flschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `flschooldata` R package installed
