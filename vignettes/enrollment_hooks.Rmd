...
This vignette explores Florida's public school enrollment data, surfacing key trends and demographic patterns across 17 years of data (2008-2024).
...
ggplot(state_totals, aes(x = end_year, y = n_students)) +
  ...
  labs(
    title = "Florida Public School Enrollment (2014-2024)",
